...
export const renderApiDefinition = (
  ...
  push('// @ts-nocheck');
  push('// This file is auto-generated by modesta.');
  ...
  push(
    renderInterfaceDefinition(
      'AccessorRequestDescriptor<TRequestBody = unknown>',
  ...
  push('export type AccessorSender = <TResponse, TRequestBody = unknown>(');
  ...
  push();
  push(
    '  return async <TResponse, TRequestBody = unknown>(request: AccessorRequestDescriptor<TRequestBody>, signal?: AbortSignal | undefined) => {'
  );
...
const renderAccessorFactory = (accessorGroup: AccessorGroupDefinition) => {
  ...
  push(
    `export const ${accessorGroup.factoryName} = (sender: AccessorSender): ${accessorGroup.interfaceName} => ({`
  );
...
const renderInterfaceDefinition = (
  ...
  const lines: string[] = [];
  lines.push(renderDocumentationComment(description));
